...
If the code examples, some parts have been removed for brevity and clarity.
...
The transformation is done at line 3, where all the parameters are inputed to create a Markov Model object, which is then used to run the Baum-Welch algorithm at line 6.
