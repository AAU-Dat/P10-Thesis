...
Initially, it implemented a partial \gls{add}-based approach, where only the calculation of E-step of the \gls{bw} algorithm were implemented using \glspl{add}.
