...
\begin{definition}[Markov Chain to Hidden Markov Model]
    ...
    \begin{itemize}
        ...
        \item $\mathscr{l}_{(s)}' =  \begin{cases}
                      1 & l=\mathscr{l}(s) \\
                      0 & \text{otherwise}
                  \end{cases}$
        \item $\tau' = \tau$.
...
The forward and backward algorithms are implemented using dynamic programming, as shown in \autoref{fig:forward-backward}.
