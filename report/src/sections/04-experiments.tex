...
For \glspl{ctmc}, the results are shown in \autoref{tab:toggle_results}, \autoref{tab:mapk_results}, \autoref{tab:cluster_results}, \autoref{tab:embedded_results}, and \autoref{tab:kanban_results}.
